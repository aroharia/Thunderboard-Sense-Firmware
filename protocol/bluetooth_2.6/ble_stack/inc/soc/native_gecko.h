...
#define gecko_cmd_homekit_dfu_start_id                                (((uint32)gecko_dev_type_gecko)|gecko_msg_type_cmd|0x09130000)
...
#define gecko_rsp_homekit_dfu_start_id                                (((uint32)gecko_dev_type_gecko)|gecko_msg_type_rsp|0x09130000)
...
PACKSTRUCT( struct gecko_msg_homekit_dfu_start_rsp_t
{
    uint16              result;
});
...
union{
    ...
    struct gecko_msg_homekit_dfu_start_rsp_t                     rsp_homekit_dfu_start;
...
/** This command can be used to make suitable HomeKit actions before Device Firmware Update. It must be call just before {a href="#cmd_dfu_reset"}DFU reset command. **/

static inline struct gecko_msg_homekit_dfu_start_rsp_t* gecko_cmd_homekit_dfu_start()
{
    
    gecko_cmd_msg->header=gecko_cmd_homekit_dfu_start_id+((0)<<8);
    gecko_handle_command(gecko_cmd_msg->header,&gecko_cmd_msg->data.payload);
            
    return &gecko_rsp_msg->data.rsp_homekit_dfu_start;
}
